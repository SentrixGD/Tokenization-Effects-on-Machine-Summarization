"""
Script: unigram_tokenizer.py
Purpose: Class of the unigram tokenizer
...
class UnigramTokenizer:
    """
    Wrapper around SentencePiece unigram tokenizer.
    ...
    def train(
        ...
        train_corpus: str,
        output_dir: str,
        model_prefix: str = "Unigram_tokenizer",
        vocab_size: int = 32000,
    ):
        """
        Train a SentencePiece unigram tokenizer on the provided corpus.
        ...
        with tempfile.NamedTemporaryFile(
            ...
            spm.SentencePieceTrainer.Train(
                ...
                input_sentence_size=150_000,
                seed_sentencepiece_size=100_000,
                num_threads=6,
