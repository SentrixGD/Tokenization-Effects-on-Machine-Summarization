"""
Script: char_tokenizer.py
Purpose: Class of the character tokenizer
...
class CharTokenizer:
    """
    Wrapper around SentencePiece Char tokenizer.
    ...
    def train(
        ...
        train_corpus: str,
        output_dir: str,
        model_prefix: str = "Char_tokenizer",
        vocab_size: int = 64,
    ):
        """
        Train a SentencePiece Char tokenizer on the provided corpus.
